...
COPY target/collector-1.0-SNAPSHOT.war /opt/ol/wlp/usr/servers/defaultServer/apps/Collector.war
COPY target/prereqs/cloudant-* /opt/ol/wlp/usr/servers/defaultServer/
COPY target/prereqs/commons-* /opt/ol/wlp/usr/servers/defaultServer/
COPY target/prereqs/gson-* /opt/ol/wlp/usr/servers/defaultServer/
